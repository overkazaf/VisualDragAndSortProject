...
content:"",
	createObj : function (e,objType,contentType,content) {
...
if(typeof(ge[3])!='undefined' && ge[3]!='0')
str +='<div id="'+id+'_right3" class="span'+ge[3]+' column"></div>';
if(typeof(ge[4])!='undefined' && ge[4]!='0')
str +='<div id="'+id+'_right4" class="span'+ge[4]+' column"></div>';
	...
	getTabHtml : function () {
		...
		str += '<div id="'+id+'_content" class="'+this.tabContentClass+'">'+this.content+'</div>';
		str += '</div>';
		return str;
	},
	getBlockHtml : function () {
		...
		var str = '<div id="'+id+'" class="block move-span">'+this.content+'</div>';
		str += '</div>';
		return str;
	},
	setClose : function () {
